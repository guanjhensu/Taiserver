...
set host 140.112.51.223
set styleTransferDir ~/NTU2017DeepArt/src/chainer-fast-neuralstyle
set model_dir ~/NTU2017DeepArt/TaiwanArt/model
...
send "time python generate.py $input_dir/$photo_name -m $model_dir/$model -o $output_dir/$photo_name -g 1\r"
expect "$ "
...
# send "cd $input_dir\r"
# expect "$ "
# send "rm $input_dir/$photo_name\r"
# expect "$ "
